...
:DIR_CHECK
ECHO IF YOU ARE NOT RUNNING THIS FROM %userprofile%\Desktop\RVN-and-Forks-Multi-QT-Tool\Windows Batch Scripts YOU NEED TO MOVE THE GITHUB PACKAGE FROM DOWNLOADS (OR WHERVER IT WENT) TO THE DESKTOP TO ENSURE THE SCRIPTS WORK!!!
CHOICE /C YN /N /M "ARE YOU RUNNING THIS FROM %userprofile%\Desktop\RVN-and-Forks-Multi-QT-Tool\Windows Batch Scripts? Y/N"%1
