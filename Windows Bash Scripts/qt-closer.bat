...
:FOXD_NO
ECHO FOXD-QT NOT CLOSED...
timeout 10
GOTO END

:CANCEL
ECHO PROCESS CANCELED!
ECHO ECHO THANKS FOR USING THIS TOOL, CONSIDER CHECKING OUT THE GITHUB, DISCORD, AND PERHAPS CONTRIBUTE OR EVEN DONATE!!!
